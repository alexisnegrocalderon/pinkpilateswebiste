 ...
 * real —redirección a un pagador dentro del sitio, webhook firmado con HMAC de
 * vuelta, verificación de firma e idempotencia por event_id— para que el día
 * que entre Mercado Pago, Flow o Webpay, lo único que cambie sea este archivo.
 */
