...
const logoSymbol = "/manus-storage/pink-pilates-symbol_47db8768.png";
...
function Mark({ inverse = false }: { inverse?: boolean }) {
  return (
    <a className={`riot-mark ${inverse ? "riot-mark-inverse" : ""}`} href="#inicio" aria-label="Pink Pilates, volver al inicio">
    ...
    <div className="riot-site">
      <header className={`riot-header ${scrolled ? "riot-header-scrolled" : ""}`}>
        ...
        <button type="button" className="riot-menu" onClick={() => setMenuOpen(true)} aria-label="Abrir navegación">
          <span>MENÚ</span><Menu size={20} strokeWidth={2.4} />
        </button>
      </header>
      ...
      <main>
        <section className="riot-hero" id="inicio">
          ...
          <div className="hero-symbol-system"><img src={logoSymbol} alt="" /><span>PINK · PRECISO · SALVAJE · REÑACA ·</span></div>
        ...
        <section className="riot-studio" id="estudio">
          ...
          <div className="studio-intro"><span>03 / EL ESTUDIO</span><h2>No es un<br /><em>gimnasio.</em><br />Es nuestro<br />territorio.</h2></div>
        ...
        <section className="riot-reserve" id="reserva">
          ...
          <div className="reserve-top"><span>04 / TU PRIMERA VEZ</span><span>CUPOS LIMITADOS · ENERGÍA ILIMITADA</span></div>
          <div className="reserve-main"><h2>Tu hora<br />feliz empieza<br />en el <em>reformer.</em></h2><a href="mailto:contacto@pinkpilates.cl?subject=Quiero%20mi%20clase%20de%20prueba" className="reserve-cta"><span>RESERVA TU CLASE</span><ArrowUpRight size={29} /></a></div>
